...
class SectionField extends Fields{
	 ...
	 * @param {AutoNumber} autoNumber70 An instance of AutoNumber
	 */
	async setAutoNumber70(autoNumber70)	{
		const AutoNumber = (await (import("../fields/auto_number.js"))).MasterModel;
		if((autoNumber70 != null) && (!(autoNumber70 instanceof AutoNumber)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: autoNumber70 EXPECTED TYPE: AutoNumber", null, null);
		}
